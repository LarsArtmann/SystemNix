{
  ...
  inputs = {
    ...
    # Both verified against the source 2026-08-20; a bump that changes either
    # silently changes agent workspace/write semantics (tests/test-hermes.nix
    # covers the env wiring, not the upstream Python behavior).
    hermes-agent = {
