      ...
      clientOptionsFile = pkgs.writeText "options.txt" (
        lib.generators.toKeyValue
          ...
          }
          {
            ...
            soundCategory_master = pctToVolume ccfg.sound.master;
            soundCategory_music = pctToVolume ccfg.sound.music;
            soundCategory_record = pctToVolume ccfg.sound.noteBlocks;
            soundCategory_weather = pctToVolume ccfg.sound.weather;
            soundCategory_block = 1.0;
            soundCategory_hostile = pctToVolume ccfg.sound.hostile;
            soundCategory_neutral = 1.0;
            soundCategory_player = 1.0;
            soundCategory_ambient = pctToVolume ccfg.sound.ambient;
            soundCategory_voice = pctToVolume ccfg.sound.voice;
      ...
      config =
        let
          serverConfig = lib.mkIf cfg.enable {
            ...
            systemd.services.minecraft-server.serviceConfig = lib.mkMerge [
              (harden {
