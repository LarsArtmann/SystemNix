...
**Resolution 2026-09-06 (docs-health pass):** root-caused, fixed upstream (`0f6ff43`), deployed gen `wir47mg5` 2026-09-03 15:46 and live-verified (zero `client_error`, Gatus auth green, smoke PASS) — CHANGELOG `InboxClean→Paperless archiving was a silent no-op`. Archived as an execution-complete record.
