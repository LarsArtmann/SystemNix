...
3. **Post-deploy WARNs not investigated:** "1 error line(s) in quickshell journal (last 1h)"; I/O pressure avg10 78–87% (hypothesis: btrbk catch-up sending the 9-day DAS gap — unverified).
...
_Generated by crush after the 2026-08-31 cv-vendorhash deploy-recovery session. Point-in-time snapshot; the parallel session was still editing the tree at write time (guard/sev1/TODO_LIST in flight)._
