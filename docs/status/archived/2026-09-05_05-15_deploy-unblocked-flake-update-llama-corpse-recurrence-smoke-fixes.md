...
**Resolution 2026-09-06 (docs-health pass):** deploy DONE + activated; crush-daily goldens advanced; the Paperless mail phantom-RED root-caused (TODO P1 row); corpse recurrence documented in AGENTS (reboot-only class). Execution-complete.
