...
**Resolution 2026-09-06 (docs-health pass):** sync enable go-live completed; the later OAuth incidents are separately tracked (TODO P1 re-consent row + AGENTS InboxClean section). Execution-complete.
