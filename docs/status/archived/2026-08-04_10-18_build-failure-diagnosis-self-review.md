...
1. **Stop presenting hypotheses as conclusions.** Every claim about _why_ should be tagged
...
5. **Distinguish structural fragility from acute breakage.** The `nixpkgs.follows`-into-Go-flakes
   pattern is a _chronic_ structural issue; the tarball regression is _acute_. Conflating them muddies
...
2. **Is the Jan-8-2026 nixpkgs pin intentional or accidental?** A 7-month-old nixpkgs is _so_ stale
