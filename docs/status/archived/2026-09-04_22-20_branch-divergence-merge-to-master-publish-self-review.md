...
**Resolution 2026-09-06 (docs-health pass):** merge + publish complete; CHANGELOG `Branch-divergence saga resolved`; the concurrent-session fallout all landed via the 2026-09-05 deploy. Execution-complete.
