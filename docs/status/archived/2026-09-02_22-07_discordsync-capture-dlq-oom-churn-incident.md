...
**Resolution 2026-09-06 (docs-health pass):** DLQ drained with zero loss (AGENTS DiscordSync section carries the runbook + the upstream `/api/dlq` scan fix); the box-level fix is the owed reboot (P0 row). Execution-complete.
