...
**Resolution 2026-09-06 (docs-health pass):** the undeployed-at-report-time fix (deviceCgroup + D-state tripwire + Gatus check) deployed with the 2026-09-05 wave; corpses clear on the owed reboot (P0); CHANGELOG `rocm.deviceCgroup`; AGENTS llama-rag section has the recurrence notes. Execution-complete.
