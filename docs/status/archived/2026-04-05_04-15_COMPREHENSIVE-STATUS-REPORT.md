...
| # | Component      | Location                               |
| - | -------------- | -------------------------------------- |
| 1 | Ollama v0.20.0 | ROCm, Flash Attention, custom data dir |
| 2 | Unsloth Studio | AI training UI, automated setup        |
| 3 | llama.cpp      | ROCWMMA optimizations for Strix Halo   |

#### Steam

| # | Component | Location               |
| - | --------- | ---------------------- |
| 1 | Steam     | Full NixOS integration |
