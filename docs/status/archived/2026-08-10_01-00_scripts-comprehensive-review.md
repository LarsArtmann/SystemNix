...
| `post-deploy-check.sh`      | `_qs_errors` journalctl pipeline under pipefail could abort script                                         | `                                                  |
...
| `verify-deployment.sh`      | `ls -t \| head -1` SIGPIPE abort                                                                           | `                                                  |
...
| `internet-diagnostic.sh`  | `ip route show \| head -20` SIGPIPE                                                            | `                                       |
...
| `pre-deploy-check.sh`     | `systemctl --failed \| head -10` SIGPIPE abort                                                 | `                                       |
| `usb-diagnostic.sh`       | 3 SIGPIPE traps (`udevadm \| head`, `journalctl \| grep \| tail`, `sort \| head`)              | `                                       |
