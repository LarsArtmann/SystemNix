...
**Resolution 2026-09-06 (docs-health pass):** VM test + §12 + docs shipped same evening — TODO row `Mail relay hardening finish` [x] DONE 2026-09-02; CHANGELOG `Mail Relay`. Execution-complete.
