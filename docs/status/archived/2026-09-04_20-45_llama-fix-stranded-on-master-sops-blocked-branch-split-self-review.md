...
**Resolution 2026-09-06 (docs-health pass):** resolved by the 22-20 merge + publish and the 2026-09-05 deploy (fix live); the missing-sops-key class became `sops-key-audit`. Archived as the stranded-state record.
