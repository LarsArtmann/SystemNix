...
**Resolution 2026-09-06 (docs-health pass):** sweep shipped (page-cluster=0 + watermark_boost=0, CHANGELOG `BTRFS internet sweep`); AGENTS ZRAM section updated (2026-09-06 pass); NOCOW row premise check + offsite DEFER are TODO rows; the research-doc forward-link landed 2026-09-06. Execution-complete.
