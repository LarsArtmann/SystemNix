...
**Resolution 2026-09-06 (docs-health pass):** the not-yet-activated generation went live 15:46 gen `wir47mg5` after the upstream ping fix — CHANGELOG `InboxClean→Paperless archiving was a silent no-op`; verification recorded in `13-25` (archived). Execution-complete.
