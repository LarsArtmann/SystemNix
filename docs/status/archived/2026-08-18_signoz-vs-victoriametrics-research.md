...
| Traces                                             | Actively wired into **10+ services** via `OTEL_EXPORTER_OTLP_ENDPOINT`; `otel-endpoint-audit.nix` _enforces_ the endpoint contract at eval time                                                                                                                                                     |
