...
The prior session's report (section d, "Process Failure: Deploying without integration testing") explicitly called out: *"I treated `nix eval` as verification when it only checks string rendering, not runtime behavior."*
