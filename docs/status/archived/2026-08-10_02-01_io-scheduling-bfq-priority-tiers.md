...
I/O scheduling makes builds _fair_ (they yield to interactive), but 4 concurrent derivations writing to CoW BTRFS still generate massive total I/O volume. Halving to 2 would roughly halve write pressure at the cost of ~2x build time. You value responsiveness over build speed, but 2x slower builds is a significant tradeoff. Only you can decide this tradeoff.
