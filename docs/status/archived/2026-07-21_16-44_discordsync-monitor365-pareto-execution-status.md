...
**Why I missed it:** This is DOCUMENTED in AGENTS.md line 301: *"DiscordSync API startup race (5-11 min) ... Do NOT add a Gatus alert that expects DiscordSync API to be up immediately after restart."* I CITED this gotcha in my own handoff notes! But I added something WORSE than a Gatus alert — an ExecStartPost that KILLS the service on every startup. I violated my own documented knowledge.
