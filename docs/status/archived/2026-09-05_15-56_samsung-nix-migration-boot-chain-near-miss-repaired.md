...
**Resolution 2026-09-06 (docs-health pass):** near-miss repaired (generation 761 + default entry verified); reboot-ready state restored; the deploy.sh exit-4 masking lesson is in the AGENTS nh/exit-4 gotcha. Execution-complete.
