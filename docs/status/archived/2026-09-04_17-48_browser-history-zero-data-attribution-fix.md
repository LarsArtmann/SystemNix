...
**Resolution 2026-09-06 (docs-health pass):** the two user steps landed 2026-09-05 (provisioning converged, attribution live-verified 8/8 accepted); CHANGELOG `Browser-history agent-token provisioning automation`. Execution-complete.
