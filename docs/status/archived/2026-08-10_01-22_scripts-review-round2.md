...
| File                                     | Bug                                                                                           | Fix                                                        |
| ---------------------------------------- | --------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| `btrfs-subvolume-inventory.sh`           | `find \| wc -l` and `find \| sort \| head -1` abort under pipefail if find returns non-zero   | Subshelled `find` with `                                   |
...
| `disk-create-p9.sh`                      | `btrfs scrub status \| head -15` SIGPIPE                                                      | `                                                          |
