...
**Resolution 2026-09-06 (docs-health pass):** SSO-only deployed, live-verified (no password field, provider auto-submit); CHANGELOG `Paperless Layer-1 SSO`; the REST-API surface follow-up (T13) is a TODO P2 row. Execution-complete.
