...
**Resolution 2026-09-06 (docs-health pass):** extraction DONE, DEPLOYED, PARITY-PROVEN; CHANGELOG `crush-config extraction`; phase-2 + polish sub-items are the TODO P3 row; the dnsblockd wedge is the existing TODO P1 row. Execution-complete.
