...
**Resolution 2026-09-06 (docs-health pass):** all six P2.5 items executed — every row in TODO_LIST Priority 2.5 is [x] DONE 2026-09-02; CHANGELOG `Black-screen/desktop follow-up batch`. Execution-complete.
