...
| _(flake.lock)_ | `nix-ssh-config` updated to `e4370ed` — fixes 4 HM SSH deprecation warnings      |
| _(upstream)_   | `github:LarsArtmann/nix-ssh-config` — migrated matchBlocks → settings            |
