...
> **PARTIALLY RESOLVED — Deploy deps fixed, browser-history deployed and healthy.** Agent deployment (2), OAuth2 (15, 32), Homepage (17), DNS (19) are done. Still open: item 1 (WebAuthn browser test), item 3 (registration lock), item 20 (OTel verification — known bug), item 21 (backup coordination), items 4–14/16/18/22–50 (upstream improvements, features, hardening).
