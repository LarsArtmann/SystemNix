...
**Resolution 2026-09-06 (docs-health pass):** deploy-gap diagnosed and resolved in the same evening's chain (22-20 merge + 09-05 wave); the flake.lock regression reconciled; CHANGELOG `Branch-divergence saga resolved`. Execution-complete.
