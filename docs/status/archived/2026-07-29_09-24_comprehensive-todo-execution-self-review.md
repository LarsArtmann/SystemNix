...
| 6  | **Forgejo/Twenty provisioners verified** — `                                                                                                                                                                                                                                                                 |                                                                                                             |
...
| 13 | **AGENTS.md: 5 new gotcha entries** — proxyTo canonical, mdi-* icons, prebuilt ELF FOD purity, switch-to-configuration+oneshot, SigNoz `                                                                                                                                                                     |                                                                                                             |
...
| - | ------------------------------ | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1 | **SigNoz rules investigation** | Provisioner now reports HTTP status codes (exits 1 on failure). The error-swallowing `                |                                                                                                                                                                                                                                                                                            |
