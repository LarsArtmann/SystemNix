...
| Aug 23–24           | Root fs sits at **0% chunk-unallocated** [docs-health 2026-09-14: RESOLVED — gate CLEARED 2026-09-02 at 222.41 GiB unallocated once the gawk exit-127 fix restored the balance jobs]. `btrfs-gc-guard` blocks GC nightly and prints recovery advice (00:00, 02:27). Scheduled Mon 04:00/05:00 balance jobs **correctly self-skip** (insufficient headroom). |
