...
| # | Item                                                                                                                                                                                                                                                                                        | What's missing                                 |
| - | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| ~~1~~ | ~~**Guard covers only 4 of 9 dead-mount vars.**~~ done (docs-health 2026-09-14: the guard now redirects NINE vars — see the 2026-09-11 storage-forensics report + home.nix `__go_cache_redirect`) | hm-session-vars exports `CARGO_HOME`, `PIP_CACHE_DIR`, `SCCACHE_DIR`, `npm_config_cache`, `PLAYWRIGHT_BROWSERS_PATH` to `/mnt/buildcache/*` too — none probed/redirected. Rust/pip/npm/playwright usage will hit the same 10 s ambush or fail | extend `__go_cache_redirect` list              |
