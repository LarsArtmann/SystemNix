...
**Resolution 2026-09-06 (docs-health pass):** all pre-reboot steps done; CHANGELOG `Samsung /nix migration — all pre-reboot steps DONE`; the reboot + acceptance checklist is the TODO Samsung Phase-1 row. Execution-complete (pre-reboot scope).
