...
- **Inventory:** 12 runCommand bodies across 9 files (8 flake.nix checks, dns-blocker ×2, systemd-graph, test-attic, test-oauth2-proxy ×2, +3 trivial `touch $out` test stubs).
