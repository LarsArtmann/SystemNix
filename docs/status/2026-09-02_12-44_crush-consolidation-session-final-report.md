...
**Resolution 2026-09-06 (docs-health pass):** the consolidation's endgame was SUPERSEDED and completed by the 2026-09-05 crush-config extraction (`docs/status/2026-09-05_21-14_crush-config-extraction-status-self-review.md` — the repo now owns the crushrc via `homeManagerModules.crush`; byte-identical 1609-model parity proven). Key rotation + minimax retirement are tracked in TODO_LIST P0 (persistent nag) / AGENTS Crush section (minimax DISABLED 2026-08-31). Remaining unstruck items are consider-level; archived as superseded-and-complete.
