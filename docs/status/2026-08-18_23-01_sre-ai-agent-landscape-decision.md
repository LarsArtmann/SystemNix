...
2. **We already built the local version.** PapDashboard's insight enricher (journal evidence reads + FastFlowLM LLM at `:52625/v1`, best-effort, never fatal) _is_ a mini AI-SRE, wired to the actual stack. An off-the-shelf agent would see none of it.
