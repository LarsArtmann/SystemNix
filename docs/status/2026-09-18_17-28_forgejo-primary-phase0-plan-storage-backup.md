...
3. **Existing-docs inventory** for the goal: found the prior `docs/planning/archived/2026-08-31_21-15_forgejo-primary-migration.md` (proposal with 5 recorded decisions), today's research session outputs, the 2026-07-22 brainstorm (sync layers, why issues can't sync, no-daemon verdict), and the 16:45 parallel-session report (baseline).
