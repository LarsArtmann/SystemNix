...
| T20 | _Gate:_ soak completion ~2026-09-17 (observation only; daily pre-reboot-check + failed-units + smoke-baseline diff)                                                                             | gate | Structural deploys blocked until then                                                 | —              | —           | time  |
| T21 | _Gate:_ Q1/Q2/Q3 user decisions — tracked separately; Q2 forces post-deploy llama re-stop until answered                                                                                        | gate | —                                                                                     | —              | —           | user  |
...
_Point-in-time snapshot (docs-health doctrine): harvest changes via TODO_LIST; annotate, never rewrite._
