...
- **Known bad file**: `/data/models/llm/gemma-4-31b-abliterated-Q8_0.gguf` fails GGUF validation with `os error 5` (EIO) — corrupt extent, part of the /data bounded-damage class (TODO_LIST P0). Re-download or delete; do NOT import into Jan.
