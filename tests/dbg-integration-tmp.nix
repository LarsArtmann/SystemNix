...
let
  ...
  positive =
    ...
    in
    {
      ...
      gatus-three-checks = builtins.map (e: e.name) c.services.gatus-config.extraEndpoints;
      ...
      monitored-unit-override = c.services.system-health.extraMonitoredServices;
