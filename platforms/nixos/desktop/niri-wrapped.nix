      ...
      swayidle = {
        ...
        Service = sd.serviceDefaultsUser { } // {
          ExecStart =
            ...
            in
            "${lib.getExe' pkgs.swayidle "swayidle"} -w timeout 14400 ${lib.getExe swayidleDpmsOff} timeout 43200 ${lib.getExe swayidleSuspend} before-sleep ${lib.getExe dms-lock}";
          TimeoutStartSec = "10s";
        };
        Install.WantedBy = [ "graphical-session.target" ];
      };
