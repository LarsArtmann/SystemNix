...
| ZFS VM configs    | VFIO PCIe passthrough PROVEN WORKING — NixOS VM (kernel 6.18.43, ZFS 2.4.3) successfully imported `datapool` mirror (2x16TB, only 21GB used — mostly disposable Docker images). SATA pool spun down (`d57c1210`). Native ZFS on host kernel 7.1 not attempted. Source: `docs/status/2026-08-10_06-44_zfs-vfio-passthrough-success.md` | Low      |
