...
| **Self-Hosted Services** | Immich (photos), Forgejo (Git), Paperless-ngx (documents + AI), SigNoz (observability), SearXNG (privacy search), Pocket ID (SSO), Hermes AI, Gatus, Homepage, PapDashboard (alert hub), Browser History, InboxClean (Gmail assistant), CV server, Crush Daily, Dozzle, Attic (binary cache), Miniflux (RSS) |
