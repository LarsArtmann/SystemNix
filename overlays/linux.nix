...
let
  ...
  # wf-recorder 0.6.0 uses AVCodec fields (sample_fmts, pix_fmts) that FFmpeg 7.x
  # made private. Override to use ffmpeg_6 until upstream wf-recorder releases a fix.
  wfRecorderFfmpeg6Overlay = _final: prev: {
